...
package com.worthwhilegames.cardgames.shared.game;
...
public class GameHelper implements GooglePlayServicesClient.ConnectionCallbacks,
    ...
    public void onConnected(Bundle connectionHint) {
        ...
        if (mClientCurrentlyConnecting == CLIENT_GAMES
            ...
            debugLog("onConnected: connection hint provided. Checking for TBMP join_game.");
    ...
    void printMisconfiguredDebugInfo() {
        ...
        debugLog("**** (3) Your join_game settings have not been published and you are ");
