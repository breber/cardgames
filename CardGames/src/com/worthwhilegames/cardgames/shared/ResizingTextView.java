 ...
 * 
 * Most of this code was copied from http://stackoverflow.com/a/5535672.
 * This TextView will now automatically scale text in order to
 * fit into the TextView. If the text is too long, it will
 * append an ellipsis to the end of the string.
 */
public class ResizingTextView extends TextView {
	 ...
	 * Our ellipse string
	 */
	private static final String mEllipsis = "É";
	...
	public interface OnTextResizeListener {
		public void onTextResize(ResizingTextView textView, float oldSize, float newSize);
	}
